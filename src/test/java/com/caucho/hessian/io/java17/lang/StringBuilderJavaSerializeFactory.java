...
/**
 * java serializer only
 * @author junyuan
 * @version StringBuilderJavaSerializeFactory.java, v 0.1 2023年11月10日 14:43 junyuan Exp $
 */
public class StringBuilderJavaSerializeFactory extends SerializerFactory {
    @Override
