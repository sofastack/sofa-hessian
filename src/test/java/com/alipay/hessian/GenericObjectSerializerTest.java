...
/**
 * @author zhaowang
 * @version : GenericObjectSerializerTest.java, v 0.1 2021年08月02日 11:59 上午 zhaowang
 */
public class GenericObjectSerializerTest {
    ...
    public void testGenericObjectSerializer() throws IOException {
        ...
        // refDef + 970 < 1024 -16 （do not flush at writeString phase, and flush when write def at the second time）
        for (int i = 0; i < 970; i++) {
            buf.append("V");
        }
